...
DB_NAMES = {
    ...
    DB_EMPLOYEE_PATH: f"{RAG_TOP_FOLDER_PATH}/employee",
}
...
# AIエージェント関連セクションに追加（問題１）
SEARCH_WIKIPEDIA_INFO_TOOL_NAME = "Wikipedia検索"
SEARCH_WIKIPEDIA_INFO_TOOL_DESCRIPTION = "Wikipedia から関連情報を検索します。歴史的背景、一般知識、用語の説明などを探す際に使用してください。"
...
SYSTEM_PROMPT_NOTICE_SLACK = """
    ...
    - `【メンション先の選定理由】`について、以下の条件に従って生成してください。
        - 選定したメンバーの名前と、その人が問い合わせ対応に適している理由を生成してください。
